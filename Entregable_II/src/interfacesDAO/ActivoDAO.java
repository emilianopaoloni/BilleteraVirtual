...
public interface ActivoDAO {
	...
	void generarMisActivos(Connection connection, String tipoA, Activo act) throws SQLException;
	...
	void swap (Connection connection, String criptoAconvertir, double monto, String criptoEsperada ) throws SQLException;
